<?php if ($adminAuthed && $footprintsMode): ?>
<section class="visitor-dashboard" aria-labelledby="visitor-dashboard-title">
<header><h2 id="visitor-dashboard-title">Footprints</h2></header>
